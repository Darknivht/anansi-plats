  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-12">
      ...
      <div className="fixed inset-0 pointer-events-none">
        <div className="absolute top-1/4 right-1/4 w-64 h-64 bg-brand-violet/5 rounded-full blur-[96px]" />
        <div className="absolute bottom-1/3 left-1/4 w-72 h-72 bg-brand-amber/5 rounded-full blur-[96px]" />
      </div>
        ...
        <GlassCard variant="elevated" padding="lg">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <p className="text-xs text-[var(--color-text-muted)]">
              ...
              <a href="#" className="text-brand-amber-light hover:text-brand-amber">Terms of Service</a>{" "}
              and{" "}
              <a href="#" className="text-brand-amber-light hover:text-brand-amber">Privacy Policy</a>.
            </p>
